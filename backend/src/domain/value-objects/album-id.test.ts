...
describe('AlbumId', () => {
  describe('create', () => {
    it('正常なUUIDで作成される', () => {
      ...
      const result = AlbumId.create(validUuid);
  ...
  describe('toJSON', () => {
    it('UUID文字列を返す', () => {
      ...
      expect(albumId.toJSON()).toBe(uuid);
    });
  });
});